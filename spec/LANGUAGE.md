...
See [docs/PHILOSOPHY.md](../docs/PHILOSOPHY.md) for the design rationale behind the language: post-syntax programming, intent as the atomic unit, specificity as optional, and the escape hatch.
